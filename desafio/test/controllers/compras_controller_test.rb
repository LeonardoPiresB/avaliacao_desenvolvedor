...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { comprador: @compra.comprador, descricao: @compra.descricao, endereco: @compra.endereco, fornecedor: @compra.fornecedor, preco: @compra.preco, quantidade: @compra.quantidade }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { comprador: @compra.comprador, descricao: @compra.descricao, endereco: @compra.endereco, fornecedor: @compra.fornecedor, preco: @compra.preco, quantidade: @compra.quantidade }
    assert_redirected_to compra_path(assigns(:compra))
  end
